...
<body>
  <main class="app" id="app">
    <section class="map-wrap">
      ...
      <div class="legend">
        <span><i class="dot" style="background:#b7222d;width:14px;height:14px"></i>4F</span>
        <span><i class="dot" style="background:#e67621;width:13px;height:13px"></i>4E</span>
        <span><i class="dot" style="background:#da9f2f;width:12px;height:12px"></i>4D</span>
  ...
  <script>
    ...
    function syncViewportSize() {{
      ...
      const height = Math.max(window.innerHeight || document.documentElement.clientHeight || 0, 420);
